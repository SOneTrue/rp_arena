...
const ServiceCard = ({icon: Icon, title, description, onClick}) => (
    ...
    >
        <div
            className="absolute inset-0 bg-gradient-to-b from-purple-900/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"/>
...
const PricingCard = ({tier, price, features, recommended = false}) => (
    ...
    >
        {recommended && (
            <div
                className="absolute top-0 right-0 bg-cyan-500 text-black text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg">
                POPULAR
            </div>
        )}
...
export default function App() {
    ...
    return (
        <div
            className="min-h-screen bg-[#0f0f11] text-white font-sans selection:bg-cyan-500 selection:text-black overflow-x-hidden">

            <nav className="fixed top-0 w-full z-50 bg-[#0f0f11]/80 backdrop-blur-md border-b border-white/5">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        <div
                            className="w-8 h-8 bg-gradient-to-br from-cyan-500 to-purple-600 rounded flex items-center justify-center">
                            <Cpu className="text-white w-5 h-5"/>
                        </div>
                        <span
                            className="text-xl font-bold tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-purple-400">
            ...
            <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-[#0f0f11]/80 via-transparent to-[#0f0f11]/80"/>
                </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-gray-400 text-sm mb-2">
                                        Длительность: <span
                                        className="text-white font-bold">{bookingData.hours} ч.</span>
                                    </label>
                                    <input
                                        type="range"
                                        min="1"
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-5xl mx-auto mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            >
                                <div
                                    className="absolute top-0 right-0 bg-cyan-500 text-black text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg">Популярный
                                </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            >
                                <div
                                    className="absolute top-0 right-0 bg-purple-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-lg">POPULAR
                                </div>
                                <h4 className="text-xl font-bold text-white mb-1">3 часа</h4>
                                <div className="flex gap-4 mt-3">
                                    <div className="flex-1 bg-gray-800 rounded-xl p-3 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="flex items-start gap-4 p-6 rounded-2xl bg-gray-900/30 border border-gray-800">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">Оптоволокно и низкий пинг для комфортной игры без
                                    лагов.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 p-6 rounded-2xl bg-gray-900/30 border border-gray-800">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">Топовые мыши и механические клавиатуры во всех
                                    зонах.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 p-6 rounded-2xl bg-gray-900/30 border border-gray-800">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">Энергетики, кофе и быстрые закуски прямо за
                                    компьютером.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul className="space-y-4 text-gray-400">
                                <li>
                                    <button onClick={() => scrollToSection('home')}
                                            className="hover:text-cyan-400 transition-colors">Главная
                                    </button>
                                </li>
                                <li>
                                    <button onClick={() => scrollToSection('pricing')}
                                            className="hover:text-cyan-400 transition-colors">Цены
                                    </button>
                                </li>
                                <li>
                                    <button onClick={() => scrollToSection('booking')}
                                            className="hover:text-cyan-400 transition-colors">Бронь
                                    </button>
                                </li>
                                <li>
                                    <button onClick={() => scrollToSection('games')}
                                            className="hover:text-cyan-400 transition-colors">Игры
                                    </button>
                                </li>
                            </ul>
                        </div>
